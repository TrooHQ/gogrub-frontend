...
const OtherSettings = ({ selectedOutlet }: any) => {
  ...
  return (
    <div>
      <h3 className="text-[24px] mt-8 mb-2 font-[500] Capitalize text-gray-500">Get Links</h3>
      ...
      <p className="text-[24px] mt-8 mb-2 font-[500] Capitalize text-gray-500">Manage Themes</p>
