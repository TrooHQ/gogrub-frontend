    ...
    <div className="w-64 min-h-screen p-2 bg-white border-r border-gray-200">
      <nav className="mt-4 space-y-6">
        <button
          ...
          className={`flex items-center space-x-3 p-3 rounded-lg ${isActive("profile") ? "bg-gray-100" : "hover:bg-gray-50"
            }`}
        >
          ...
          />
          <span
            className={`${isActive("profile") ? "text-[#121212] font-medium" : "text-[#929292] font-normal"
        ...
        <button
          ...
          className={`flex items-center space-x-3 p-3 rounded-lg ${isActive("branch") ? "bg-gray-100" : "hover:bg-gray-50"
            }`}
        >
        ...
        <button
          ...
          className={`flex items-center space-x-3 p-3 rounded-lg ${isActive("security") ? "bg-gray-100" : "hover:bg-gray-50"
            }`}
        >
          <Password
          ...
          />
          <span
            className={`${isActive("security") ? "text-[#121212] font-medium" : "text-[#929292] font-normal"
              } text-[16px] leading-[24px] tracking-[0.5px]`}
          >
            Password
          </span>
