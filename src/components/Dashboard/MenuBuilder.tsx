    ...
    <div>
      ...
      <DashboardLayout>
        ...
        <div>
          ...
          {/* Add and edit menu category */}
          <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
            <AddMenuCategory setIsModalOpen={setIsModalOpen} editCategory={categoryEdit} handleEditCategoryConfirm={handleEditCategoryConfirm} setCategoryEdit={setCategoryEdit} />
          </Modal>
